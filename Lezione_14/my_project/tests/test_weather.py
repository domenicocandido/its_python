...
def test_check_weather1():
    assert check_weather(21.00) == "hot", "temperatures greater than 20 degree must be consdiered as hot"
...
def test_check_weather5():
    assert check_weather(30.00) == "hot", "temperatures greater than 20 degree must be consdiered as hot"
